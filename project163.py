...
Question3=Label(root, text ="Do you experience persistent wheezing / coughing that produce whit or pink blood tinged mucus??")
Question3.pack()
...
Question4=Label(root, text ="Do you experience persistent wheezing / coughing that produce whit or pink blood tinged mucus??")
Question4.pack()
...
def fever_score():
    ...
    if score <= 20:
        messagebox.showinfo("Report","You don't have to visit the doctor.")
